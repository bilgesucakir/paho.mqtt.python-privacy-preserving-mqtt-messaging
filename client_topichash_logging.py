...
class ConsoleUi:
    ...
    def __init__(self, frame):
        ...
        self.scrolled_text = ScrolledText(frame, state='disabled', height=40,width=85)
        ...
        self.frame.after(50, self.poll_log_queue)

    def display(self, record):
        msg = self.queue_handler.format(record)
        #msg = "level:" + str(record.levelname) + " --- " + self.queue_handler.format(record)
...
class FormUi:
    def __init__(self, frame):
        ...
        ttk.Entry(self.frame, textvariable=self.message, width=100).grid(column=1, row=1, sticky=(W, E))
    ...
    def submit_message(self):
        ...
        #msg = "msg: " + self.message.get() + " -----level: " + str(lvl) + " end"
...
class xxFormUi:
    ...
    def submit_message(self):
        # Get the logging level numeric value
        lvl = getattr(logging, self.level.get())
        logger.log(lvl, self.message.get() + str(lvl))
